...
<img src="/fastapi/img/deployment/https/https01.svg">
...
<img src="/fastapi/img/deployment/https/https02.svg">
...
<img src="/fastapi/img/deployment/https/https03.svg">
...
<img src="/fastapi/img/deployment/https/https04.svg">

### Decrypt the Request

The TLS Termination Proxy would use the encryption agreed to **decrypt the request**, and would transmit the **plain (decrypted) HTTP request** to the process running the application (for example a process with Uvicorn running the FastAPI application).

<img src="/fastapi/img/deployment/https/https05.svg">

### HTTP Response

The application would process the request and send a **plain (unencrypted) HTTP response** to the TLS Termination Proxy.

<img src="/fastapi/img/deployment/https/https06.svg">
...
<img src="/fastapi/img/deployment/https/https07.svg">
...
<img src="/fastapi/img/deployment/https/https08.svg">
...
<img src="/fastapi/img/deployment/https/https.svg">
